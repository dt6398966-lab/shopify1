// Check if order #1050 is synced in database
import { PrismaClient } from '@prisma/client';
const prisma = new PrismaClient();

async function checkOrder() {
  try {
    console.log('🔍 Checking database for order #1050...\n');
    
    // Order ID from the URL: 5714017321044
    const orderId = 5714017321044;
    ...
    if (orderEvents.length > 0) {
      ...
      if (recentOrders.length > 0) {
        ...
        console.log('   2. Webhook endpoint is not working');
